        ...
        <div ref={containerProjects} >
            <div className={style.SectionPoints} >
                ...
                <div className="si" style={{ width: "30px", height: "0px", display: "flex", alignItems: "center", justifyContent: "space-between", flexDirection: "column", overflow: "hidden", position: 'relative', willChange: "transform" }}>
                    <SectionPointProjects onClick={() => handleClickProjects(`project${0}`, `svgWhiteClickProjects${0}`, `svgPinkProjects${0}`)} onMouseOver={() => handleMouseOverProjects(`svgWhiteProjects${0}`)} classPointer={"#project0"} index={0} handleMouseLeave={() => handleMouseLeave(`svgWhiteProjects${0}`)} />
                    <SectionPointProjects onClick={() => handleClickProjects(`project${1}`, `svgWhiteClickProjects${1}`, `svgPinkProjects${1}`)} onMouseOver={() => handleMouseOverProjects(`svgWhiteProjects${1}`)} classPointer={"#project1"} index={1} handleMouseLeave={() => handleMouseLeave(`svgWhiteProjects${1}`)} />
                    <SectionPointProjects onClick={() => handleClickProjects(`project${2}`, `svgWhiteClickProjects${2}`, `svgPinkProjects${2}`)} onMouseOver={() => handleMouseOverProjects(`svgWhiteProjects${2}`)} classPointer={"#project2"} index={2} handleMouseLeave={() => handleMouseLeave(`svgWhiteProjects${2}`)} />
                    <SectionPointProjects onClick={() => handleClickProjects(`project${3}`, `svgWhiteClickProjects${3}`, `svgPinkProjects${3}`)} onMouseOver={() => handleMouseOverProjects(`svgWhiteProjects${3}`)} classPointer={"#project3"} index={3} handleMouseLeave={() => handleMouseLeave(`svgWhiteProjects${3}`)} />
                </div>
